...
export default function VerifyEmailPage() {
  ...
  return (
    <div style={{ width: '100%', maxWidth: 420, fontFamily: 'var(--font-body)' }}>
      <div style={{ background: '#111111', border: '1px solid #262626', padding: '48px 36px', textAlign: 'center' }}>
        ...
        {state === 'verifying' && (
          <>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: 6, marginBottom: 20 }}>
              {[0, 1, 2].map((i) => (
                <div key={i} style={{
                  width: 8, height: 8, background: '#0057FF', borderRadius: '50%',
        ...
        {state === 'success' && (
          <>
            ...
            <div style={{ width: '100%', height: 2, background: '#1a1a1a', borderRadius: 1 }}>
              <div style={{ height: '100%', background: '#0057FF', width: '100%', animation: 'progress 2s linear' }} />
            </div>
          </>
        )}
        ...
        {state === 'error' && (
          <>
            <div style={{ fontSize: 40, color: '#FF5B5B', marginBottom: 20 }}>✗</div>
            <div style={{ fontSize: 14, color: '#fff', fontWeight: 600, letterSpacing: '0.06em', marginBottom: 12 }}>
              VERIFICATION FAILED
            </div>
            <div style={{ background: '#1a0000', border: '1px solid #FF5B5B33', padding: '12px 16px',
                          fontSize: 11, color: '#FF8A8A', letterSpacing: '0.06em', marginBottom: 24, borderRadius: 8 }}>
              {message}
            </div>
            <div style={{ display: 'flex', gap: 10, flexDirection: 'column' }}>
              <button
                ...
                style={{ width: '100%', background: '#0057FF', color: '#fff', border: 'none',
