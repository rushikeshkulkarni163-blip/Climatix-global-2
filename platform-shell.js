...
(function () {
  ...
  const NAV_ITEMS = [
    ...
    { id: 'climate',     label: 'ORBIT™ — Climate Intelligence',  href: 'platform-climate-risk.html',   icon: ICONS.climate,    status: 'stub' },
    { id: 'risk',        label: 'ORBIT™ — Risk Assessment',       href: 'platform-risk-assessment.html',icon: ICONS.risk,       status: 'stub' },
    { id: 'company',     label: 'Company Profiles',               href: 'platform-company-intel.html',  icon: ICONS.company,    status: 'live' },
    { id: 'supply',      label: 'ATLAS™',                         href: 'platform-supply-chain.html',   icon: ICONS.supply,     status: 'stub' },
    { id: 'regulatory',  label: 'SIGNAL™ — Regulatory Intelligence', href: 'platform-regulatory.html',  icon: ICONS.regulatory, status: 'live' },
    { id: 'sustain',     label: 'Sustainability Performance',     href: 'platform-sustainability.html', icon: ICONS.sustain,    status: 'stub' },
    { id: 'scenarios',   label: 'VECTOR™',                        href: 'platform-scenarios.html',      icon: ICONS.scenarios,  status: 'live' },
    { id: 'narrative',   label: 'PRISM™ — Greenwashing Intelligence', href: 'platform-narrative.html',  icon: ICONS.narrative,  status: 'live' },
